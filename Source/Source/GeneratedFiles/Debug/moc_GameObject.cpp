...
QT_MOC_LITERAL(8, 95, 12) // "SetZRotation"
    ...
    "GameObject\0xRotationChanged\0\0angle\0"
...
void GameObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GameObject::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameObject::xRotationChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (GameObject::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameObject::yRotationChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (GameObject::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameObject::zRotationChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void GameObject::xRotationChanged(int _t1)
{
...
// SIGNAL 1
void GameObject::yRotationChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void GameObject::zRotationChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
